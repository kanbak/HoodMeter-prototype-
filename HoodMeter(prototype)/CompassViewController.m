    ...
    [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError *error)
     {
         ...
         if (nwCrimeVolume <=100) {
             ...
             (nwCrimeVolume >=100 && nwCrimeVolume <=299){
                 nwView.backgroundColor = [UIColor colorWithRed:254.0/255.0 green:254.0/255.0 blue:34.0/255.0 alpha:1];}//yellow
         else if
             (nwCrimeVolume >=300 && nwCrimeVolume <=599){
                 nwView.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:131.0/255.0 blue:0.0/255.0 alpha:1];}//orange
         else if
             (nwCrimeVolume >=600){
         ...
         if (neCrimeVolume <=100) {
             ...
             (neCrimeVolume >=100 && neCrimeVolume <=299){
                 neView.backgroundColor = [UIColor colorWithRed:254.0/255.0 green:254.0/255.0 blue:34.0/255.0 alpha:1];}//yellow
         else if
             (neCrimeVolume >=300 && neCrimeVolume <=599){
                 neView.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:131.0/255.0 blue:0.0/255.0 alpha:1];}//orange
         else if
             (neCrimeVolume >=600){
         ...
         if (swCrimeVolume <=100) {
             ...
             (swCrimeVolume >=100 && swCrimeVolume <=299){
                 swView.backgroundColor = [UIColor colorWithRed:254.0/255.0 green:254.0/255.0 blue:34.0/255.0 alpha:1];}//yellow
         else if
             (swCrimeVolume >=300 && swCrimeVolume <=599){
                 swView.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:131.0/255.0 blue:0.0/255.0 alpha:1];}//orange
         else if
             (swCrimeVolume >=600){
         ...
         if (seCrimeVolume <=100) {
             ...
             (seCrimeVolume >=100 && seCrimeVolume <=299){
                 seView.backgroundColor = [UIColor colorWithRed:254.0/255.0 green:254.0/255.0 blue:34.0/255.0 alpha:1];}//yellow
         else if
             (seCrimeVolume >=300 && seCrimeVolume <=599){
                 seView.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:131.0/255.0 blue:0.0/255.0 alpha:1];}//orange
         else if
             (seCrimeVolume >=600){
         ...
         if (currentLocationRegionCrimeVolumeCount <=10) {
             ...
             (currentLocationRegionCrimeVolumeCount >=11 && currentLocationRegionCrimeVolumeCount <=20){
                 currentLocationView.backgroundColor = [UIColor colorWithRed:254.0/255.0 green:254.0/255.0 blue:34.0/255.0 alpha:1];}//yellow
         else if
             (currentLocationRegionCrimeVolumeCount >=21 && currentLocationRegionCrimeVolumeCount <=30){
                 currentLocationView.backgroundColor = [UIColor colorWithRed:255.0/255.0 green:131.0/255.0 blue:0.0/255.0 alpha:1];}//orange
         else if
