...
//        _communityAreaNumber =[crimeDictionary valueForKey:@"community_area"];
        ...
        _latitudeNumber = [NSNumber numberWithDouble:[[crimeDictionary valueForKey:@"latitude"] doubleValue]];
        _longitudeNumber = [NSNumber  numberWithDouble:[[crimeDictionary valueForKey:@"longitude"] doubleValue]];
